export const purchasingMessages = {
  en: {
    ...
    searchDraftsHint: "Search: invoice # / supplier / date",
    ...
    unpaid: "Unpaid",
    draftBadge: "Draft",
    invoiceCountUnit: "invoices",
    draftCountUnit: "drafts",
    doubleClickHint: "Double-click a row to open full invoice",
    doubleClickDraftHint: "Double-click a row to open draft",
    totalSummary: "Total",
    ...
    afterCommitHint:
      "Controls which column receives focus when starting the next row.",
    ...
    duplicatePostWarning:
      "Duplicate supplier invoice warning: an invoice with this same supplier number already exists.",
    dismissPosted: "Continue with fresh invoice",
    accountingAuditDetails: "Accounting & audit details",
    accountCash: "Cash / Drawer",
    accountInventory: "Inventory",
    accountSupplierPayable: "Supplier Payable",
    accountInventoryCountVariance: "Inventory Count Variance",
    ...
    searchPostedHint: "Search: invoice # / supplier / staff / date",
    fromDate: "From date",
    toDate: "To date",
    sortBy: "Sort by",
  ...
  ar: {
    ...
    searchDraftsHint: "بحث: رقم الفاتورة / المذخر / التاريخ",
    ...
    unpaid: "غير مسددة",
    draftBadge: "مسودة",
    invoiceCountUnit: "فاتورة",
    draftCountUnit: "مسودة",
    doubleClickHint: "نقرة مزدوجة على السطر لفتح الفاتورة كاملة",
    doubleClickDraftHint: "نقرة مزدوجة على السطر لفتح المسودة",
    ...
    visible: "ظاهر",
    afterCommit: "موضع المؤشر بعد حفظ البند",
    afterCommitHint:
      "يحدد الحقل الذي يبدأ فيه مؤشر الإدخال عند الانتقال للبند التالي في الفاتورة.",
    newRow: "فتح بند جديد (أول حقل في الترتيب)",
    ...
    warnings: "التحذيرات",
    post: "حفظ الفاتورة",
    posting: "جارٍ حفظ الفاتورة…",
    postExplicitHint:
      "لا يتم حفظ الفاتورة وتحديث المخزون إلا عند تفعيل هذا الزر.",
    postRejected: "رُفض الحفظ ولم تتغير المسودة.",
    expiryRequiredPost:
      "رُفض الحفظ: تاريخ الانتهاء إلزامي للمنتجات الدوائية والمبردة.",
    lotRequiredPost: "رُفض الحفظ: رقم التشغيلة إلزامي قبل الحفظ.",
    missingRequiredReceiptEvidence:
      "لا يمكن الحفظ: يوجد بند أو أكثر بلا تاريخ انتهاء إلزامي.",
    deleteRow: "حذف البند",
    editRow: "تعديل البند",
    saveRow: "حفظ",
    cancelEdit: "إلغاء",
    ...
    postRetryPending:
      "تعذر تأكيد النتيجة. سيعيد Breev محاولة الحفظ نفسها بأمان بعد إعادة التحميل.",
    postedPurchase: "فاتورة شراء محفوظة",
    postedSuccess: "تم حفظ فاتورة الشراء وتحديث المخزون بنجاح.",
    versionConflictPost:
      "تعارض في النسخة: تم تعديل المسودة. يرجى مراجعتها وإعادة الحفظ.",
    ...
    credit: "دائن",
    duplicatePostWarning:
      "تنبيه تكرار فاتورة المورد: توجد فاتورة سابقة محفوظة بنفس رقم فاتورة المورد هذا.",
    dismissPosted: "المتابعة بفاتورة جديدة",
    accountingAuditDetails: "تفاصيل القيد المحاسبي والتدقيق",
    accountCash: "الصندوق / النقدية",
    accountInventory: "حساب المخزون",
    accountSupplierPayable: "ذمم الموردين",
    accountInventoryCountVariance: "فروقات الجرد المخزني",
    ...
    searchPosted: "البحث في فواتير الشراء",
    searchPostedHint: "بحث: رقم الفاتورة / المذخر / الموظف / التاريخ",
    fromDate: "من تاريخ",
    toDate: "إلى تاريخ",
    sortBy: "الترتيب حسب",
    ...
    postingDate: "تاريخ الإدخال",
    todayPreset: "اليوم",
    yesterdayPreset: "أمس",
    last7DaysPreset: "آخر 7 أيام",
    ...
    reviewFirstBoundary: "هذه أول فاتورة شراء.",
    reviewLastBoundary: "هذه آخر فاتورة شراء.",
    costsHiddenByPermission:
    ...
    itemInfoBar: "شريط معلومات المادة",
    detailedBalance: "الرصيد بالتفصيل",
    totalDetailed: "الإجمالي",
