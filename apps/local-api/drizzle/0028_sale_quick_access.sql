create table sale_quick_access_settings (
...
revoke all on table sale_quick_access_settings from public;
--> statement-breakpoint
grant select, insert, update on table sale_quick_access_settings to breev_app;
--> statement-breakpoint
insert into permission_definitions (name) values ('sales.quick_access.manage')
...
with eligible_roles as (
  ...
  select pharmacy_id, role_id, 'sales.quick_access.manage', granted_by
  from eligible_roles
