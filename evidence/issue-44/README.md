...
> **Acceptance.** _The application installs and runs on the main device without internet, and four devices work simultaneously over LAN (Wi-Fi or Ethernet). An authorized user signs in from any licensed device according to their role. Disabled features are hidden, and licensing can increase the permitted device count without a fixed software limit._
